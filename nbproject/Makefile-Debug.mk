...
${OBJECTDIR}/GETCommand.o: GETCommand.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/GETCommand.o GETCommand.cpp

${OBJECTDIR}/HelperFunction.o: HelperFunction.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HelperFunction.o HelperFunction.cpp

${OBJECTDIR}/OPTIONSCommand.o: OPTIONSCommand.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/OPTIONSCommand.o OPTIONSCommand.cpp

${OBJECTDIR}/POSTCommand.o: POSTCommand.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/POSTCommand.o POSTCommand.cpp
